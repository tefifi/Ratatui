...
class AppTheme {
  ...
  static const Color salvia =
      Color(0xFFEAF1E4); // fondo de tiles/badges (verde)
  static const Color crema =
      Color(0xFFFBF1DD); // fondo cálido alterno (dorado suave)
  ...
  static TextTheme get _textTheme {
    ...
    return base.copyWith(
      ...
      bodyMedium:
          GoogleFonts.manrope(fontSize: 13.5, color: carbon, height: 1.45),
      labelLarge:
  ...
  static ThemeData get light => ThemeData(
        ...
        chipTheme: ChipThemeData(
          ...
          labelStyle: GoogleFonts.manrope(
              fontSize: 13, fontWeight: FontWeight.w600, color: carbon),
